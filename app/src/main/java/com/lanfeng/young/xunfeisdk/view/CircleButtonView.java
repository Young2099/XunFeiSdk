package com.lanfeng.young.xunfeisdk.view;
...
public class CircleButtonView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressColor = a.getColor(R.styleable.CircleButtonView_progressColor, Color.parseColor("#6699ff"));
        a.recycle();
        //初始画笔抗锯齿、颜色
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case WHAT_LONG_CLICK:
                    ...
                    //内外圆动画，内圆缩小，外圆放大
                    startAnimation(mBigRadius, mBigRadius * 1.1f, mSmallRadius, mSmallRadius * 0.7f);
                    break;
            }
        }
    };
